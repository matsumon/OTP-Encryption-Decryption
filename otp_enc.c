...
int main(int argc, char *argv[])
{
	...
	int q;
	for(q=0; q<strlen(givenText)-1;q++)
	{
	...
	char buffer[strlen(givenText)*2+1];
	...
	charsRead = recv(socketFD, buffer,strlen(givenText), 0); // Read data from the socket, leaving \0 at end
